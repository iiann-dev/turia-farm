...
export const SITE_CONFIG = {
  ...
  mapsEmbed:
    "https://maps.google.com/maps?q=-7.966309,112.104104&z=17&output=embed&hl=id",
  mapsLink:
    "https://maps.app.goo.gl/1JoVp95SYZGqq8Yi6",
  geo: {
    lat: -7.966309,
    lng: 112.104104,
  },
...
export const SEEDLINGS: SeedlingItem[] = [
  ...
  },
  {
    ...
    sweetness: "Kayu Ringan & Putih",
    height: "Tinggi 30 - 60 cm (Bibit)",
    price: { id: "Rp 2.500 / polybag", en: "$0.16 / seedling" },
    image: "/images/bibit-sengon.jpg",
    status: { id: "Tersedia Siap Tanam", en: "Ready to Plant" },
  ...
  },
  {
    ...
    sweetness: "Serat Halus & Mudah Kering",
    height: "Tinggi 30 - 50 cm (Bibit)",
