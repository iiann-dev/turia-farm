...
export const Footer: React.FC = () => {
  ...
  return (
    <footer className="bg-[#00251d] text-[#faf9f3] pt-20 pb-12 border-t border-[#173b32]">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-12 gap-12 pb-16 border-b border-[#173b32]/80">
          {/* Brand Col */}
          <div className="lg:col-span-5 space-y-4">
            <div className="flex items-center gap-3">
              <BananaLogo size={40} className="border-emerald-700/50" />
              <div className="font-serif text-2xl font-bold tracking-tight text-[#faf9f3]">
                Turia Farm
              </div>
            </div>
            ...
            <div className="text-xs text-[#80a691] pt-2">
              {SITE_CONFIG.address}
            </div>
          </div>
          ...
          <div className="lg:col-span-3 space-y-3">
            <div className="text-xs font-bold uppercase tracking-wider text-[#c4ebde] mb-4">
              {t("footer.quickLinks")}
            </div>
            <ul className="space-y-2.5 text-xs text-[#a8cfc2]">
              <li>
              ...
              {SEEDLINGS.slice(0, 4).map((s) => (
                <li key={s.id}>
                  ...
                  >
                    ...
                    <span className="text-[#80a599] text-[11px]">{s.price[lang]}</span>
                  </Link>
                </li>
              ))}
            </ul>
        ...
        {/* Bottom Bar */}
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-4 text-xs text-[#80a691]">
          <div>
